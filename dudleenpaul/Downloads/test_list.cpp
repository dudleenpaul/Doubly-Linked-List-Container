...
using namespace cop4530;
	...
	class isOdd {
	public:
	bool operator()(int n) const //if n is input, if n is odd then it'll return true but if not, boo!, const doesn't modift it
	{
        return n % 2 != 0; //no parentheses allowed
    }
	...
	public: 
	bool operator()(const std::string& str) //constantly references string without modifying
	const {return str.length() > 5; } //if the length of the string is greater than 5 then it returns true
    // TO BE FILLED
	};
